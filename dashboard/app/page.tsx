    ...
    <div className="min-h-screen bg-white text-[#0A0A0B] overflow-x-hidden" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <header className={`sticky top-0 z-50 bg-white transition-shadow duration-200 ${scrolled ? "shadow-[0_1px_0_0_rgba(0,0,0,0.08)]" : ""}`}>
        <nav className="max-w-7xl mx-auto px-6 h-[100px] flex items-center justify-between gap-6">
          <Link href="/" className="flex items-center self-center shrink-0">
            <Image src="/repath-logo.png" alt="Repath" width={297} height={95} style={{ height: 95, width: "auto" }} className="object-contain block" />
          </Link>
